...
I work with HTML, CSS and JavaScript to bring designs to life, ensuring they're not just functional but also aesthetically pleasing. Whether it's crafting clean, minimalistic interfaces or building dynamic, interactive layouts, I love the challenge of making the web both beautiful and efficient. My expertise extends to frameworks like React, and Bootstrap, helping me build responsive and high-performance applications that adapt to the ever-evolving digital landscape.
...
My journey has been shaped by my upbringing in a close-knit family, where I learned to value experiences over possessions. That mindset reflects in my work—I strive to create experiences that truly matter, ones that leave a lasting impression.
